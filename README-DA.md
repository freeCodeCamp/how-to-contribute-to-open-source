...
<details>
<summary>
<strong> Læs den her i andre sproger </strong>
</summary>
    <ul>
        ...
        <li><a href="./README-DK.md"> Dansk </a></li>
    </ul>
</details>
<!-- Do not translate this -->

# Velkommen til jer nye *open-source* bidragyere!
...
Den her er en liste af resourcer for personer der er nye til at bydragyere til *Open Source*.

Hvis du finder mere resourcer, du må meget gernes laver en *pull-request*.

Hvis du har sporgsmåler eller kommentater, vær sød at lave en *issue*.

**Indeholder**

- [Bidragyering til *Open-Source* generalt](#contributing-to-open-source-in-general)
- [Direkt Github søgninger](#direct-github-searches)
- [Mozillas bidragyere økøsystem](#mozillas-contributor-ecosystem)
- [God artikler for nye *Open-Source* bidragyere](#useful-articles-for-new-open-source-contributors)
- [Hvordan man bruger Version Kontrol](#using-version-control)
- [*Open Source* bøger](#open-source-books)
- [*Open Source* bidragyering initiativer](#open-source-contribution-initiatives)
- [Licens](#license)
...
- [45 Github Issuer - Hvad man skal gør og ikke gør](https://hackernoon.com/45-github-issues-dos-and-donts-dfec9ab4b612) - Do's and Don'ts on GitHub.
- [GitHub Guides](https://guides.github.com/) - basic guides on how to use GitHub effectively.
- [Bidragyere til Open Source](https://github.com/danthareja/contribute-to-open-source) - Learn the GitHub workflow by contributing code to a simulation project.
- [Linux Foundations Open Source Guides for Enterprisen](https://www.linuxfoundation.org/resources/open-source-guides/) - The Linux Foundation's guides to Open Source projects.
- [CSS Tricks - En Open Source Guidebook](https://css-tricks.com/open-source-etiquette-guidebook/) - An Open Source Etiquette Guidebook, written by Kent C. Dodds And Sarah Drasner.
...
## God artikler for nye Open-Source bidragyere
...
## Hvordan man bruger Version Kontrol
...
## Open Source bidragyering initiativer
