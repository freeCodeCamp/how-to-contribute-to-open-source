...
- [GitHub Guides](https://guides.github.com/) - Getting started with GitHub.
...
- [Contributing to your First Open Source Project: A Practical Approach](https://blog.devcenter.co/contributing-to-your-first-open-source-project-a-practical-approach-1928c4cbdae) - A step-by-step approach to your first contribution to open source project by [Abati Adewale](https://www.acekyd.com).
