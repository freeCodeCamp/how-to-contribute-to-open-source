...
- [कुछ ओपन सोर्स कार्यक्रम जिनमें आप भाग ले सकते हैं](#open-source-programs-to-participate-in)
- [ओपन सोर्स योगदान पहल](#open-source-contribution-initiatives)
- [लाइसेंस](#license)

## सामान्य रूप से ओपन सोर्स में योगदान करना

> यहां ओपन सोर्स की दुनिया और संस्कृति पर चर्चा करने वाले कुछ लेख और संसाधन हैं।
...
- [An Intro to Open Source](https://www.digitalocean.com/community/tutorial_series/an-introduction-to-open-source) - GitHub पर आपकी सफलता में आपका मार्गदर्शन करने के लिए DigitalOcean द्वारा ट्यूटोरियल।
...
- [Forge Your Future with Open Source](https://pragprog.com/titles/vbopens/forge-your-future-with-open-source/) ($) - यह पुस्तक ओपन सोर्स को समझाने, एक परियोजना खोजने और योगदान करने के तरीके को समर्थन करती है। सॉफ्टवेयर विकास में सभी भूमिकाओं को शामिल करती है, केवल प्रोग्रामर्स नहीं।
...
- ["Getting Started with Open Source" by NumFocus](https://github.com/numfocus/getting-started-with-open-source) - 
एक GitHub रेपो जो सहयोगियों को ओपन-सोर्स में प्रवेश की बाधाओं को पार करने में मदद करता है।
- ["Opensoure-4-everyone" by Chryz-hub](https://github.com/chryz-hub/opensource-4-everyone) - एक ओपन सोर्स से संबंधित सबकुछ पर आधारित रेपो। यह एक प्रोजेक्ट है जो GitHub सदस्यता की दृश्यता में मदद करने, मौलिक और उन्नत गिट कमांड्स के साथ अभ्यास करने, ओपन सोर्स के साथ शुरुआत करने, और बहुत कुछ में मदद करने के लिए है।
- ["Open Advice"](http://open-advice.org/) - विभिन्न मुक्त सॉफ्टवेयर परियोजनाओं से ज्ञान संग्रह। यह सवाल का उत्तर देता है कि जब वे शुरुआत करते थे तो 42 प्रमुख सहयोगी क्या जानना चाहते थे, इसलिए आप कैसे और कहां सहयोग करें, आपको एक पहल की शुरुआत मिल सकती है चाहे आप कहीं भी और कैसे भी सहयोग करें।
- ["GitHub Skills"](https://skills.github.com) - GitHub Skills के साथ अपने कौशलों को बढ़ाएं। हमारा मित्रपुरुष बॉट आपको आपकी आवश्यकता के कौशल सीखने के लिए एक सीरीज़ में मजेदार, व्यावहारिक परियोजनाओं से गुजारेगा और रास्ते में सहायक प्रतिक्रिया साझा करेगा।
- ["Ten simple rules for helping newcomers become contributors to open projects"](https://doi.org/10.1371/journal.pcbi.1007296) - इस लेख में कई समुदायों के अध्ययन और सदस्यों, नेताओं और अनुवेक्षकों के अनुभवों पर आधारित नियमों का वर्णन किया गया है जो नए सहयोगियों को ओपन प्रोजेक्ट में सहयोगी बनने में मदद करते हैं।
- ["Step-by-Step guide to contributing on GitHub"](https://www.dataschool.io/how-to-contribute-on-github/) - यह एक कदम-दर-कदम मार्गदर्शिका है जिसमें सहयोगी चित्रों और लिंकों के साथ ओपन सोर्स प्रोजेक्ट में सहयोग करने की पूरी प्रक्रिया के संबंध में है।
- [Open Source with Pradumna](https://github.com/Pradumnasaraf/open-source-with-pradumna) - यह रेपो रिसोर्सेज और सामग्री शामिल करता है जिससे ओपन सोर्स, गिट, और गिटहब के साथ शुरुआत करने की सीखें और खुद को शुरुआत करें।
- ["FOSS Community Acronyms"](https://github.com/d-edge/foss-acronyms) - यह रेपो एक सूची है जिसमें फ्री और ओपन सोर्स समुदाय में प्रयोग किए जाने वाले छोटे शब्दों की सूची है, साथ ही उनके परिभाषा और उपयोग भी शामिल है।
- ["Open Source Fiesta - Open Source Fiesta"](https://zubi.gitbook.io/open-source-fiesta/) - यह रेपो एक सीधे-सीधे निर्देशिका है जिसमें बताया गया है कि GitHub रेपोजिटरी में सहयोग करने के लिए कैसे चलते हैं, और इसमें गिट कमांड लाइन चीटशीट भी शामिल है।
- ["6 Best Practices to Manage Pull Request Creation and Feedback"](https://doordash.engineering/2022/08/23/6-best-practices-to-manage-pull-request-creation-and-feedback/) - यह जेना कियासू, डूरडैश इंजीनियरिंग के सॉफ्टवेयर इंजीनियर द्वारा, पुल अनुरोध बनाने और प्रतिक्रिया का प्रबंधन करने के लिए 6 सर्वश्रेष्ठ अभ्यासों का वर्णन करता है।
- ["Contribute to the Open-Source Community"](https://arijitgoswami.hashnode.dev/contribute-to-the-open-source-community) - ओपन सोर्स सॉफ्टवेयर के लाभ, ओपन सोर्स प्रोजेक्ट के आंतरिक कार्य को कैसे समझें और पहला सहयोग कैसे करें के बारे में जानें।
- ["Complete Guide to Open Source - How to Contribute"](https://www.youtube.com/watch?v=yzeVMecydCE) (41:52) - इस वीडियो में एडी जाऊदे के साथ ओपन सोर्स सॉफ्टवेयर में सहयोग करने के लिए क्यों और कैसे सीखें।
...
> Mozilla को स्वस्थ इंटरनेट के लिए वचनबद्ध किया गया है और इसके साथ ही इसके ओपन-सोर्स प्रोजेक्ट्स में सहयोग के लिए अवसर हैं।
...
- [MDN Web Docs](https://developer.mozilla.org/en-US/docs/MDN/Contribute) - MDN Web Docs टीम को सहायता करें और वेब प्लेटफ़ॉर्म के दस्तावेज़ीकरण में सहायता करें, सामग्री समस्याएं और प्लेटफ़ॉर्म बग्स को ठीक करके।
...
> नए सहयोगियों के लिए मददगार लेख और ब्लॉग्स जो उन्हें शुरुआत करने के लिए दिशा-निर्देश देते हैं।

- [GitHub पर ओपन सोर्स के लिए सहयोग करने के तरीके खोजना](https://docs.github.com/en/get-started/exploring-projects-on-github/finding-ways-to-contribute-to-open-source-on-github) by [@GitHub](https://github.com/github)
...
- [ओपन-सोर्स के लिए एक संवेदनशील प्राथमिक गाइड](https://developeraspire.hashnode.dev/an-immersive-introductory-guide-to-open-source) by [Franklin Okolie](https://twitter.com/DeveloperAspire)
- [ओपन-सोर्स में योगदान देना शुरू करना](https://stackoverflow.blog/2020/08/03/getting-started-with-contributing-to-open-source/) by [Zara Cooper](https://stackoverflow.blog/author/zara-cooper/)
- [ओपन-सोर्स योगदान के लिए शुरुआती गाइड](https://workat.tech/general/article/open-source-contribution-guide-xmhf1k601vdj) by [Sudipto Ghosh](https://github.com/pydevsg)
- [गैर-कोड तरीके ओपन-सोर्स में योगदान देने के लिए 8 तरीके](https://opensource.com/life/16/1/8-ways-contribute-open-source-without-writing-code) by [OpenSource](https://twitter.com/OpenSourceWay)
- [ओपन सोर्स सॉफ्टवेयर क्या है? ओएसएस को सरल अंग्रेजी में समझाया गया है](https://www.freecodecamp.org/news/what-is-open-source-software-explained-in-plain-english/) by [Jessica Wilkins](https://www.freecodecamp.org/news/author/jessica-wilkins/)
- [GitHub पर एक ओपन-सोर्स प्रोजेक्ट शुरू करने के लिए - मेरे ट्रेंडिंग रिपो को बनाने के टिप्स।](https://www.freecodecamp.org/news/how-to-start-an-open-source-project-on-github-tips-from-building-my-trending-repo/) by [@Rishit-dagli](https://github.com/Rishit-dagli)
- [अच्छे पहले इश्यूज़ खोजें](https://community.codenewbie.org/bdougie/finding-good-first-issues-33a6) by [Brian Douglas](https://community.codenewbie.org/bdougie)

## संस्करण नियंत्रण का उपयोग करना

> विभिन्न स्तरों पर वर्जन कंट्रोल का उपयोग करने के लिए ट्यूटोरियल और संसाधन, आम तौर पर Git और GitHub पर।

- [Video tutorial for Git and Github by Harvard University](https://www.youtube.com/watch?v=NcoBAfJ6l2Q) - हार्वर्ड विश्वविद्यालय द्वारा एक ट्यूटोरियल, जो उनके CS50 वेब विकास पाठ्यक्रम का हिस्सा है, जिसमें Git और GitHub को समझना और Git के कमांडों के साथ काम करना शामिल है।
...
- [Git Cheat Sheets](https://devhints.io/?q=git) - Git पर ग्राफिकल चीट शीट्स का सेट।
- [Complete Git and GitHub Tutorial](https://www.youtube.com/watch?v=apGV9Kg7ics) (1:12:39) - पूर्ण गिट और गिटहब वॉकथ्रू by [Kunal Kushwaha](https://www.youtube.com/channel/UCBGOUQHNNtNGcGzVq5rIXjw).
- [A Tutorial Introduction to Git](https://git-scm.com/docs/gittutorial) - गिट के लिए एक ट्यूटोरियल।
- [First Aid Git](https://firstaidgit.io/#/) - यहां Git से सबसे अधिक पूछे जाने वाले सवालों का एक संवेदनशील संग्रह है। इन सवालों के जवाब व्यक्तिगत अनुभव, StackOverFlow से और Git के आधिकारिक दस्तावेज़ीकरण से एकत्र किए गए हैं।
- [Git by Susan Potter](https://www.aosabook.org/en/git.html) - यह दिखाता है कि गिट के विभिन्न तकनीकी पहलुओं का काम कैसे करता है और वितरित वर्कफ़्लो को सक्षम करने के लिए और यह अन्य संस्करण नियंत्रण प्रणालियों (VCs) से कैसे अलग है।

## ओपन सोर्स पुस्तकें

> ओपन सोर्स से संबंधित सभी चीजों पर पुस्तकें: संस्कृति, इतिहास, श्रेष्ठ अभ्यास, आदि।
...
> यहां प्रारंभकर्ताओं के लिए काम करने के लिए संग्रहित पहचानी जाने वाली मुद्दों या मौसमी घटनाओं की सूची है।
...
- [Ovio](https://ovio.org) - यह एक प्लेटफ़ॉर्म है जिसमें अनुदानकर्ता-मित्र प्रोजेक्टों का एक चुनिंदा संग्रह है। इसमें एक [शक्तिशाली इश्यू खोज उपकरण](https://ovio.org/issues) है जो आपको प्रोजेक्ट और इश्यू को बाद में सहेजने की अनुमति देता है।
- [Contribute-To-This-Project](https://github.com/Syknapse/Contribute-To-This-Project) - यह एक ट्यूटोरियल है जो पहली बार सहयोगियों की मदद करता है और उन्हें एक सरल और आसान प्रोजेक्ट में भाग लेने और GitHub का उपयोग करने में आसानी प्रदान करता है।
- [Open Source Welcome Committee](https://www.oswc.is/) - ओपन सोर्स वेलकम कमेटी (OSWC) नए सहयोगियों को ओपन सोर्स के अद्भुत दुनिया में शामिल होने में मदद करता है। आपके ओपन सोर्स प्रोजेक्ट्स को हमारे साथ सबमिट करें!

## ओपन सोर्स कार्यक्रम जिनमें हिस्सा लेने के लिए।

> यह एक प्रोग्राम, इंटर्नशिप या फैलोशिप होता है जो समुदाय द्वारा आयोजित किया जाता है और इसके माध्यम से शुरुआती सहयोगियों को मेंटरों और संसाधनों के साथ मिलाकर ओपन-सोर्स सॉफ्टवेयर प्रोजेक्ट में सहयोग करने में मदद की जाती है।
...
- [Google Summer of Code](https://summerofcode.withgoogle.com/) - यह एक वार्षिक रूप से चलाया जाने वाला भुगतान किया जाने वाला प्रोग्राम है जिसे गूगल द्वारा संचालित किया जाता है। इसका मुख्य उद्देश्य छात्र डेवलपर्स को ओपन-सोर्स सॉफ्टवेयर विकास में लाना है।
- [Girlscript Summer of Code](https://gssoc.girlscript.tech/) - गर्लस्क्रिप्ट फाउंडेशन द्वारा हर गर्मी के दौरान आयोजित एक तीन महीने की ओपन-सोर्स प्रोग्राम। सतत प्रयासों के साथ, प्रतिभागियों को इन महीनों में कई प्रोजेक्टों में योगदान देना होता है जिनके लिए उन्हें कुशल मेंटरों के अत्यधिक मार्गदर्शन के तहत काम करना पड़ता है। ऐसे अनुभव से, छात्र अपने घरों की सुविधा से ही वास्तविक विश्व के प्रोजेक्टों में योगदान करना शुरू करते हैं।
- [Hacktoberfest](https://hacktoberfest.digitalocean.com)
- [Hyperledger Mentorship Program](https://wiki.hyperledger.org/display/INTERN) - Iअगर आप ब्लॉकचेन में रुचि रखते हैं, तो यह आपके लिए है। आप Hyperledger में सहयोग कर सकते हैं। यह मेंटरशिप प्रोग्राम आपको Hyperledger ओपन-सोर्स विकास में व्यावहारिक अनुभव प्राप्त करने की अनुमति देता है। आपको Hyperledger डेवलपर्स समुदाय में बहुत सक्रिय मेंटर अनुबंधित किए जाएंगे।
- [LF Networking Mentorship](https://wiki.lfnetworking.org/display/LN/LFN+Mentorship+Program)
- [Microsoft Reinforcement Learning](https://www.microsoft.com/en-us/research/academic-program/rl-open-source-fest/)
- [Major League Hacking (MLH) Fellowship](https://fellowship.mlh.io/) - यह एक रिमोट इंटर्नशिप का विकल्प है जो तकनीशियनों के लिए है, जहां वे ओपन-सोर्स प्रोजेक्ट बना सकते हैं या उनमें योगदान कर सकते हैं।
- [Open Summer of Code](https://osoc.be/students)
- [Open Mainframe](https://www.openmainframeproject.org/all-projects/mentorship-program) - ओपन मेनफ्रेम प्रोजेक्ट भी अपने खुद के ओपन-सोर्स प्रोग्राम रखता है और मेंटीज मेनफ्रेम टेक्नोलॉजी पर अपने ज्ञान को विस्तारित कर सकते हैं।
- [Outreachy](https://www.outreachy.org)
- [Processing Foundation Internship](https://processingfoundation.org/fellowships/)
- [Rails Girls Summer of Code](https://railsgirlssummerofcode.org/) - एक वैश्विक फैलोशिप कार्यक्रम जो महिला और गैर-बाइनरी कोडर्स के लिए है जहां वे मौजूदा ओपन-सोर्स प्रोजेक्टों पर काम करते हैं और अपने कौशल सेट को विस्तारित करते हैं।
- [Redox OS Summer of Code](https://www.redox-os.org/rsoc/) - रेडक्स ओएस समर ऑफ कोड रेडक्स ओएस प्रोजेक्ट के लिए चंदा का प्राथमिक उपयोग है। इसमें छात्रों का चयन किया जाता है जिन्होंने पहले से ही रेडक्स ओएस में योगदान करने की इच्छा और क्षमता प्रदर्शित की है।
- [Social Summer of Code](https://ssoc.devfolio.co/) - सोशल फाउंडेशन इस दो महीने की गर्मी के कार्यक्रम में छात्रों को ओपन-सोर्स संस्कृति के बारे में सीखने और समुदाय में शामिल होने का अवसर प्रदान करता है। प्रतिभागी अनुभवी मेंटरों के मार्गदर्शन में वास्तविक जीवन परियोजनाओं में सहयोग करते हैं।
- [Season of KDE](https://season.kde.org/) - "The Season of KDE," जिसे KDE समुदाय द्वारा आयोजित किया जाता है, एक ऐसा आउटरीच कार्यक्रम है जो पूरी दुनिया के सभी व्यक्तियों के लिए है। KDE एक अंतरराष्ट्रीय मुक्त सॉफ्टवेयर समुदाय है जो मुक्त और ओपन-सोर्स सॉफ्टवेयर विकसित करता है, और आप Season of KDE कार्यक्रम के माध्यम से KDE को सहयोग दे सकते हैं।
