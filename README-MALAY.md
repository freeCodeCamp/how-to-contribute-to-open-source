...
Jika anda jumpa maklumat tambahan, sila menekankan pull request tersebut.

Jika anda mempunyai soalan atau komentar, sila membuat satu isu tentang soalan atau komentar tersebut.

**Kandungan**
- [Menyumbang kepada Sumber Terbuka secara umum](#contributing-to-open-source-in-general)
- [Enjin carian GitHub secara langsung](#direct-github-searches)
...
- [Mengguna Pengawalan Versi](#using-version-control)
...
Tutorial oleh DigitalOcean untuk membantu anda menuju kejayaan menyumbang di sini di GitHub.
...
- [Awesome-for-beginners](https://github.com/MunGell/awesome-for-beginners) - repo GitHub yang mengumpulkan projek dengan pepijat yang baik untuk penyumbang baru, dan menggunakan label untuk menghuraikan.
- [Open Source Guides](https://opensource.guide/) - Pengumpulan sumber untuk individu, komuniti, dan syarikat yang ingin belajar bagaimana menjalankan dan menyumbang kepada projek Sumber Terbuka.
- [45 Github Issues Dos and Don’ts](https://hackernoon.com/45-github-issues-dos-and-donts-dfec9ab4b612) - Lakukan dan Jangan Lakukan di GitHub.
- [GitHub Guides](https://guides.github.com/) - panduan asas bagaimana mengguna GitHub secara efektif.
...
- [A to Z Resources for Students](https://github.com/dipakkr/A-to-Z-Resources-for-Students) - Sumber dan peluang untuk pelajar kolej mempelajari bahasa pengekodan baru.
- [Pull Request Roulette](http://www.pullrequestroulette.com/) - Laman web ini mempunyai senarai permintaan tarik yang dikirimkan untuk ditinjau milik projek Sumber Terbuka yang dihoskan di Github.
- ["How to Contribute to an Open Source Project on GitHub" by Egghead.io](https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github) - Panduan video langkah demi langkah bagaimana untuk mula menyumbang kepada projek Sumber Terbuka di GitHub.
...
- ["How to get started with Open Source by" Sayan Chowdhury](https://www.hackerearth.com:443/getstarted-opensource/) - Artikel ini merangkumi sumber untuk menyumbang kepada sumber terbuka untuk pemula berdasarkan minat bahasa kegemaran mereka.
...
## Enjin carian GitHub secara langsung
...
- [Firefox DevTools](http://firefox-dev.tools/) - laman web yang dikhaskan untuk bug yang difailkan untuk alat pembangun dalam penyemak imbas Firefox.
...
## Menggunakan Pengawalan Versi
- [Think Like (a) Git](http://think-like-a-git.net/) - Pengenalan Git untuk "pemula maju", tetapi masih berusaha, untuk memberi anda strategi mudah untuk bereksperimen dengan selamat dengan git.
- [Try Git](https://try.github.io/) - Belajar Git dalam 15 minit dalam laman anda.
- [Everyday Git](https://git-scm.com/docs/giteveryday) - Satu set perintah minimum yang berguna untuk Everyday Git.
- [Oh shit, git!](https://ohshitgit.com/) - cara mengatasi kesalahan `git` yang biasa dijelaskan dalam bahasa Inggeris biasa; lihat juga [Dangit, git!](https://dangitgit.com/) untuk halaman tanpa sumpah.
...
- [GitHub Flow](https://www.youtube.com/watch?v=juLIxo42A_s) (42:06) - bagaimana menarik tarik permintaan diajar oleh GitHub
- [GitHub Learning Resources](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/git-and-github-learning-resources) - Git dan GitHub sumber pelajaran
...
- [Git Best Practices](https://sethrobertson.github.io/GitBestPractices/) - Lakukan Selalunya, Sempurna Kemudian, Terbitkan Sekali: Git Amalan Terbaik
- [Git Interactive Tutorial](https://learngitbranching.js.org/) - Belajar Git secara visual dan interaktif

## Buku untuk Sumber Terbuka
- [Producing Open Source Software](https://producingoss.com/) - Menghasilkan Perisian Sumber Terbuka adalah buku mengenai sisi manusia dalam pembangunan Sumber Terbuka. Ini menggambarkan bagaimana projek yang berjaya dijalankan, harapan pengguna dan pembangun, dan budaya perisian percuma.
...
- [Up For Grabs](https://up-for-grabs.net/) - Mengandungi projek untuk penyumbang yang baru.
...
- [24 Pull Requests](https://24pullrequests.com) - 24 permintaan tarik adalah projek untuk mempromosikan kolaborasi Sumber Terbuka pada bulan Disember.
