...
# Добродошли у отворени код за почетнике!

[![Pull Requests Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat)](https://makeapullrequest.com)
[![first-timers-only Friendly](https://img.shields.io/badge/first--timers--only-friendly-blue.svg)](https://www.firsttimersonly.com/)
[![Check Resources](https://github.com/freeCodeCamp/how-to-contribute-to-open-source/actions/workflows/test.yml/badge.svg)](https://github.com/freeCodeCamp/how-to-contribute-to-open-source/actions/workflows/test.yml)

Ово је листа ресурса за људе који су нови доприношењу отвореном коду.

Ако нађете додатне ресурсе, молимо креирајте нови pull request.

Ако имате питање или коментар, молимо креирајте нови issue.

**Садржај**

- [Доприношење отвореном коду уопштено](#доприношење-отвореном-коду-уопштено)
- [Директно претраживање Гитхаба](#директно-претраживање-гитхаба)
- [Мозилин екосистем за доприносе](#мозилин-екосистем-за-доприносе)
- [Корисни артикли за нове contributor-е отвореног кода](#корисни-артикли-за-нове-contributor-е-отвореног-кода)
- [Кориштење система за контроле верзија](#кориштење-система-за-контроле-верзија)
- [Књиге о отвореном коду](#књиге-о-отвореном-коду)
- [Иницијативе доприноса отвореном коду](#иницијативе-доприноса-отвореном-коду)
- [Програми отвореног кода у којим можете учествовати](#програми-отвореног-кода-у-којим-можете-учествовати)
- [Лиценце](#лиценце)

## Доприношење отвореном коду уопштено

> Артикли и ресурси о свијету и култури орвореног кода.
...
## Директно претраживање Гитхаба

> Линкови за претраживање који воде директно до погодних `issues` за доприношење на Гитхабу.
...
## Мозилин екосистем за доприносе

> Мозила се заклиње за здрав интернет, самим тиме има пуно прилика да се доприноси њеним пројектима отвореног кода.
...
## Корисни артикли за нове contributor-е отвореног кода

> Корисни артикли и блогови за нове contributor-е о томе како почети.
...
## Кориштење система за контроле верзија

> Туторијали и ресурси разних нивоа о томе како користити системе за контролу верзија, типично Git и GitHub.
...
## Књиге о отвореном коду

> Књиге о свему и свачему о отвореном коду: култура, историја, добра пракса, итд.
...
## Иницијативе доприноса отвореном коду

> Листа материјала који садрже проблеме на којима почетници могу радити.
...
## Програми отвореног кода у којим можете учествовати

> Програми или праксе од стране заједнице да помогну спојити почетнике са менторима и ресурсима да допринесу софтверу орвореног кода.
