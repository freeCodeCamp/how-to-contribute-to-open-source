<details>
<summary>
<strong>Читайте цей посібник іншими мовами (розгорніть для перегляду)</strong>
</summary>
    <ul>
...
# Ласкаво просимо нових розробників Open Source!
...
Це список ресурсів для новачків, які хочуть взяти участь у Open Source проектах.

Якщо ви знайдете додаткові ресурси, будь ласка, створіть pull request.

Якщо у вас є запитання чи коментарі, будь ласка, створіть issue.

**Зміст**

- [Внесення вкладу в Open Source (статті англійською)](#contributing-to-open-source-in-general)
- [Прямий пошук на GitHub](#direct-github-searches)
- [Екосистема учасників Mozilla](#mozillas-contributor-ecosystem)
- [Корисні статті для нових учасників Open Source (статті англійською)](#useful-articles-for-new-open-source-contributors)
- [Використання контролю версій (статті англійською)](#using-version-control)
- [Книги по Open Source](#open-source-books)
- [Ініціативи внеску Open Source](#open-source-contribution-initiatives)
- [Програми для участі в Open Source](#open-source-programs-to-participate-in)
- [Ліцензія](#license)

## Внесення вкладу в Open Source (статті англійською)
...
Пошук по ярликах для роботи з Open Source на GitHub.
...
## Екосистема учасників Mozilla
- [Good First Bugs](https://bugzil.la/sw:%22[good%20first%20bug]%22&limit=0) - Список помилок, рекомендованих для початківців.
- [MDN Web Docs](https://developer.mozilla.org/en-US/docs/MDN/Contribute) - Допоможіть команді MDN Web Docs документувати веб-платформу, виправивши проблеми з вмістом та помилки платформи.
- [Mentored Bugs](https://bugzilla.mozilla.org/buglist.cgi?quicksearch=mentor%3A%40) - Помилки, які мають наставника, який буде на IRC, щоб допомогти вам, коли ви застрягнете під час роботи над ними.
- [Bugs Ahoy](https://www.joshmatthews.net/bugsahoy/) - Вебсайт присвячений пошуку помилок на Bugzilla.
- [Firefox DevTools](http://firefox-dev.tools/) - Вебсайт, присвячений помилкам в інструменті розробника в браузері Firefox.
- [What Can I Do For Mozilla](https://whatcanidoformozilla.org/) - З’ясуйте, над чим ви можете працювати, відповівши на запитання про свої навички та інтереси.
- [Start Mozilla](https://twitter.com/StartMozilla) - Обліковий запис Twitter, у якому пишуть про проблеми, які підходять для нових учасників екосистеми Mozilla.

## Корисні статті для нових учасників Open Source (статті англійською)
...
## Використання контролю версій (статті англійською)
...
## Ініціативи внеску в Open Source
...
## Програми для участі в Open Source
...
## Ліцензія
<a rel="license" href="https://creativecommons.org/licenses/by-sa/4.0/deed.uk">
  <img alt="Creative Commons License" style="border-width:0" src="https://licensebuttons.net/l/by-sa/4.0/88x31.png" />
</a>
<br />Ця робота ліцензована за міжнародною ліцензією <a rel="license" href="https://creativecommons.org/licenses/by-sa/4.0/deed.uk">Creative Commons Attribution-ShareAlike 4.0 International License</a>.
