...
- ["Відкритий код - 4 для усіх" від Chryz-hub](https://github.com/chryz-hub/opensource-4-everyone) - Репозиторій про все, що стосується відкритого програмного забезпечення. Проект для підвищення видимості членів на GitHub, вправ з основними і продвинутими командами Git, початку роботи з відкритим вихідним кодом та інших аспектів.
