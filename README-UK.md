...
# Вітаємо новачків-контрибуторів відкритого коду!
...
- [Екосистема контрибуторів Mozilla](#mozillas-contributor-ecosystem)
- [Корисні статті для новачків-контрибуторів відкритого коду](#useful-articles-for-new-open-source-contributors)
...
- [Вступ до відкритого програмного забезпечення](https://www.digitalocean.com/community/tutorial_series/an-introduction-to-open-source) - Майстер-класи від DigitalOcean, які допоможуть вам успішно брати участь у проектах з відкритим кодом на GitHub.
...
- [Творіть своє майбутнє з відкритим кодом](https://pragprog.com/titles/vbopens/forge-your-future-with-open-source/) ($) - Книга, присвячена поясненню відкритого коду, як знайти проект та як почати вносити свій вклад. Включає всі ролі у розробці програмного забезпечення, не тільки програмістів.
- [Чудова підбірка для новачків](https://github.com/MunGell/awesome-for-beginners) - GitHub репозиторій, який збирає проекти з хорошими багами для новачків, та застосовує мітки для їх опису.
- [Підбірка ресурсів по Open Source](https://opensource.guide/) - Колекція ресурсів для осіб, спільнот та компаній, які хочуть навчитися керувати та вносити внесок у проекти з відкритим кодом.
...
- [Беріть участь у проектах з відкритим вихідним кодом](https://github.com/danthareja/contribute-to-open-source) - Вивчіть робочий процес GitHub, вносячи код до симуляційного проекту.
...
- ["Як внести свій вклад у проект з відкритим вихідним кодом на GitHub" від Egghead.io](https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github) - Покроковий відеопосібник, як почати вносити вклад у проекти з відкритим вихідним кодом на GitHub.
- [Внесок у відкрите програмне забезпечення: Покроковий огляд від початку до кінця](https://medium.com/@kevinjin/contributing-to-open-source-walkthrough-part-0-b3dc43e6b720) - Цей покроковий огляд внеску у відкрите програмне забезпечення охоплює все, від вибору підходящого проекту та роботи над проблемою, до мержу пул-реквесту.
- ["Як внести свій вклад у проект з відкритим вихідним кодом" від Sarah Drasner](https://css-tricks.com/how-to-contribute-to-an-open-source-project/) - Вони зосереджуються на деталях внесення пул-реквесту (PR) до чужого проекту на GitHub.
...
- ["Як внести свій вклад у проект з відкритим вихідним кодом" від Maryna Z](https://rubygarage.org/blog/how-contribute-to-open-source-projects) - Ця вичерпна стаття спрямована на бізнеси (але все ще корисна для індивідуальних учасників), де йдеться про те, чому, як і до яких проектів з відкритим вихідним кодом варто вносити вклад.
...
- ["Відкритий код - 4 для усіх" від Chryz-hub](https://github.com/chryz-hub/opensource-4-everyone) - Репозиторій з усім, що стосується відкритого програмного забезпечення. Це проект, спрямований на покращення публічності учасників GitHub, вивчення основних і продвинутих команд Git, початок роботи з відкритим програмним забезпеченням та інше.
- ["Поради"](http://open-advice.org/) - Підбірка матеріалів з великого спектру проектів відкритого програмного забезпечення. Відповідає на питання про те, що б 42 видатних контриб'ютори хотіли б знати, коли вони починали. Цу допоможе вам почати, незалежно від того, як і де ви вносите свій внесок.
...
- ["Десять простих правил для допомоги новачкам стати контриб'юторами у проектах з відкритим кодом."](https://doi.org/10.1371/journal.pcbi.1007296) - Ця стаття охоплює правила, побудовані на основі досліджень багатьох спільнот і досвіду членів, лідерів і спостерігачів.
- ["Покроковий посібник щодо роботи з відкритим вихідним кодом на GitHub"](https://www.dataschool.io/how-to-contribute-on-github/) - покроковий посібник з візуальними матеріалами та посиланнями щодо всього процесу розробки проекту з відритим програмним забезпеченням.
...
- ["Свято вільного програмного забезпечення"](https://zubi.gitbook.io/open-source-fiesta/) - Покрокова інструкція щодо розробки проекту з відритим програмним забезпеченням у репозиторіях GitHub, а також шпаргалка стосовно Git команд.
...
- ["Внесок у відкрите програмне забезпечення"](https://arijitgoswami.hashnode.dev/contribute-to-the-open-source-community) - Переваги вільного програмного забезпечення, як розібратися у внутрішніх процесах відкритого проекту та зробити перший внесок.
...
## Екосистема контрибуторів Mozilla
...
## Корисні статті для новачків-контрибуторів відкритого коду
