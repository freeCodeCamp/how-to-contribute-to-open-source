...
- [An Intro to Open Source](https://www.digitalocean.com/community/tutorial_series/an-introduction-to-open-source) -   برای موفقیت شما در مسیر مشارکت در گیت‌هاب DigitalOcean آموزش‌هایی توسط .
