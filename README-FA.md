...
# مشارکت کنندگان تازه وارد متن باز، خوش آمدید.

[![Pull Requests Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat)](http://makeapullrequest.com)
[![first-timers-only Friendly](https://img.shields.io/badge/first--timers--only-friendly-blue.svg)](http://www.firsttimersonly.com/)
[![Check Resources](https://github.com/freeCodeCamp/how-to-contribute-to-open-source/actions/workflows/test.yml/badge.svg)](https://github.com/freeCodeCamp/how-to-contribute-to-open-source/actions/workflows/test.yml)

این فهرستی از منابع برای افراد تازه وارد در زمینه مشارکت متن باز است.
...
- [مشارکت در متن باز بطور کلی](#مشارکت-در-متن-باز-بطور-کلی)
- [جستجو مستقیم گیت هاب](#جستجو-مستقیم-گیت-هاب)
- [اکوسیستم مشارکت کننده موزیلا](#اکوسیستم-مشارکت-موزیلا)
- [مقالات مفید برای مشارکت کنندگان جدید متن باز](#مقالات-مفید-برای-مشارکت-کنندگان-جدید-منبع-باز)
- [استفاده از کنترل نسخه](#استفاده-از-کنترل-نسخه)
- [کتاب‌های متن باز](#کتاب‌های-متن-باز)
- [ابتکارات مشارکت متن باز](#ابتکارات-مشارکت-متن-باز)
- [شرکت در برنامه‌های متن باز](#شرکت-در-برنامه‌های-متن-باز)
- [مجوز](#مجوز)
...
## مشارکت در متن باز بطور کلی

> مقالات و منابعی که درباره جهان و فرهنگ متن باز صحبت می‌کند.
...
> موزیلا برای یک اینترنت سالم متعهد شده و با آن فرصت هایی برای مشارکت در پروژه های متن باز خود دارد.
...
> مقاله‌ها و وبلاگ‌های مفیدی برای مشارکت‌کنندگان جدید در مورد نحوه شروع کار.
...
> آموزش ها و منابع در سطوح مختلف در مورد استفاده از کنترل نسخه، به طور معمول Git و GitHub.
...
> کتاب‌هایی درباره همه چیز متن باز: فرهنگ، تاریخ، بهترین روش‌ها و غیره.
...
## ابتکارات مشارکت متن باز

> فهرستی از ابتکاراتی که مشکلات آسان و یا رویدادهای فصلی را برای کار جمع آوری می کند.
...
## شرکت در برنامه‌های متن باز

> برنامه، کارآموزی یا کمک هزینه تحصیلی که توسط یک جامعه میزبانی می‌شود تا به تطبیق مشارکت‌کنندگان مبتدی با مربیان و منابعی برای مشارکت در پروژه‌های نرم‌افزار متن باز کمک کند.
