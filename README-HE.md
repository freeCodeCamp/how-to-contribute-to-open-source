...
- [פרויקטי קוד פתוח שניתן להשתתף בהם](#open-source-programs-to-participate-in)
- [רישיון](#license)
...
- ["מתחילים לעבוד עם קוד פתוח" לפי NumFocus](https://github.com/numfocus/getting-started-with-open-source) - גיטהאב repo שעוזר לתורמים לצלוח מחסומים בכניסה לקוד הפתוח.
- ["Opensoure-4-everyone" לפי Chryz-hub ](https://github.com/chryz-hub/opensource-4-everyone) - גיטהאב repository על כל מה שקשור לקוד פתוח. זה פרויקט שיכול לעזור עם הרשאות צפייה בגיטהאהב, תרגול הפקודות הבסיסיות של גיט, התחלת עבודה עם הקוד הפתוח ועוד.
...
- [הארכיטקטורה של אפליקציות קוד פתוח](https://www.aosabook.org/en/git.html) - מגוון היבטים המתארים כיצד גיט עובד מתחת למנוע כדי לאפשר workflows מבוזרים וכיצד אלו שונים ממערכות version controls אחרים (VCSs).
