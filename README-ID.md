...
# Selamat Datang Contributor Open Source Pemula!
...
Berikut ini adalah list sumberdaya untuk para pemula yang baru pertama kali berkontribusi untuk Open Source.
...
- [Pencarian Di Github Secara Langsung](#direct-github-searches)
- [Ekosistem Kontribusi Mozilla](#mozillas-contributor-ecosystem)
- [Artikel bermanfaat untuk para kontributor Open Source](#useful-articles-for-new-open-source-contributors)
...
- [Issuehub.pro](http://issuehub.pro/) - Web untuk melakukan pencarian issue di Github melalui label dan bahasa.
- [Code Triage](https://www.codetriage.com/) - Web lain yang baik untuk mencari issue dan repositori populer lewat filter bahasa.
- [Awesome-for-beginners](https://github.com/MunGell/awesome-for-beginners) - Sebuah repositori Github yang berisi project dengan bug ringan untuk para contributor baru, dan menggunakan label sebagai penjelasannya.
- [Open Source Guides](https://opensource.guide/) - Koleksi sumber daya untuk individu, komunitas, dan perusahaan yang berminat untuk mempelajari bagaimana menjalan dan berkontribusi pada projek Open Source.
