...
- [Issuehub.io](http://issuehub.io/) - narzędzie do wyszukiwania kwestii na podstawie etykiet *(ang. Labels)* i języków.
- [Code Triage](https://www.codetriage.com/) - kolejne bardzo fajne narzędzie do znajdowania popularnych repozytoriów i filtrowania kwestii na podstawie języka.
- [Awesome-for-beginners](https://github.com/MunGell/awesome-for-beginners) - GitHub repozytorium które gromadzi projekty z dobrymi bugami dla początkujących kontrybutorów i stosuje etykiety do ich opisywania.
- [Open Source Guides](https://opensource.guide/) - Zbiór poradników dla pojedyńczych, grup i firm które chcą się nauczyć jak kontrybuować do projektów otwartego oprogramowania.
...
- [Contribute to Open Source](https://github.com/danthareja/contribute-to-open-source) -  Naucz się jak działają i przepływają informacje na GitHubie poprzez kontrybuowanie do projektów symulacyjnych.
...
- [A to Z Resources for Students](https://github.com/dipakkr/A-to-Z-Resources-for-Students) - Upożądkowana lista poradników i możliwości dla studentów do nauki nowego języka programowania.
- [Pull Request Roulette](http://www.pullrequestroulette.com/) - Ta strona zawiera listę pull request-ów zgłoszonych do przejrzenia należących do projektów otwartego oprogramowania  znajdujących się na GitHubie.
...
- [Contributing to Open Source: A Live Walkthrough from Beginning to End](https://medium.com/@kevinjin/contributing-to-open-source-walkthrough-part-0-b3dc43e6b720) - Przewodnik o świecie kontrybuowania do otwartego oprogramowania zawiera wszystko od wybrania odpowiedniego projektu, praca na zgłoszoną kwestią *(ang. issue)*, aż do zgłoszenia własnego PR (Pull Request) i o połączenie go do głównej gałęzi.
- ["How to Contribute to Open Source Project by" Sarah Drasner](https://css-tricks.com/how-to-contribute-to-an-open-source-project/) - W tym poradniką autorzy skupiają się na zasadniczych zasadach kontrybuowania pull request-a do nie swojego projektu na GitHubie.
...
- ["How to Contribute to Open Source Project" by Maryna Z](https://rubygarage.org/blog/how-contribute-to-open-source-projects) - Ten artykuł skierowany jest głównie w kierunku zespołów biznesowych (ale może okazać się użyteczny dla indywidualnych autorów) gdzie mówi o tym Czemu, Jak i po co kontrybuować do projektów Open Source
- ["start-here-guidelines" by Andrei](https://github.com/zero-to-mastery/start-here-guidelines) -Wskazówki jak działa społeczność GitHuba i na jakich zasadach opiera się kontrybuowanie do projektów Open Source. Szczególnie zaprojektowane do celów edukacyjnych i do celów praktycznych.
...
- [Good First Bugs](https://bugzil.la/sw:%22[good%20first%20bug]%22&limit=0) - bugi które programiści zidentyfikowali za dobre do wprowadzenia do projektu.
- [Mentored Bugs](https://bugzilla.mozilla.org/buglist.cgi?quicksearch=mentor%3A%40) - bugi które mają mentora przypisanego, który będzie na IRC aby pomóc ci kiedy utkniesz podczas naprawiania owego błędu.
...
- [What Can I Do For Mozilla](https://whatcanidoformozilla.org/) -  Dowiedz się nad czym możęsz pracować poprzez odpowiedźna kilka pytań dotyczących twoich umiejętności i zainteresowań. 
- [Start Mozilla](https://twitter.com/StartMozilla) - Konto na Twitterze, które tweetuje na temat kwestii odpowiadających początkującym kontrybutorom w środowisku Mozilli.
...
- [Think Like (a) Git](http://think-like-a-git.net/) - Wstęp do systemu kontroli wersji Git dla ,,zaawansowanych początkujących'', którzy ciąglę mają problemy. W celu przedstawienia prostej strategii prostego eksperymentowania z gitem. 
...
- [Oh shit, git!](https://ohshitgit.com/) -Jak rozwiązać pospolite problemy napotkane podczas używania gita, opisane w prostym języku angielkskim. Zobacz również[Dangit, git!](https://dangitgit.com/)  stronę bez przekleństw.
- [Atlassian Git Tutorials](https://www.atlassian.com/git/tutorials) - Różne poradniki o używaniu Gita
- [GitHub Git Cheat Sheet](https://education.github.com/git-cheat-sheet-education.pdf) (PDF)
- [freeCodeCamp's Wiki on Git Resources](https://forum.freecodecamp.org/t/wiki-git-resources/13136)
- [GitHub Flow](https://www.youtube.com/watch?v=juLIxo42A_s) (42:06) -  Wykład gitHuba o tym jak tworzyć pull Request-y
- [GitHub Learning Resources](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/git-and-github-learning-resources) - Źródła do nauki Git-a i GitHub-a
- [Pro Git](https://git-scm.com/book/en/v2) - The entire Pro Git book, written by Scott Chacon and Ben Straub and published by Apress. Cała książka na temat Gita, napisana Scott Chacon i Ben Straub przez i opublikowana przez Apress. 
- [Git-it](https://github.com/jlord/git-it-electron) -  Poradnik krok po kroku na temat aplikacji Gita na komputer.
- [Flight Rules for Git](https://github.com/k88hudson/git-flight-rules) - Poradnik na temat tego co robić gdy coś pójdzie nie tak jak powinno.
- [Git Guide for Beginners in Spanish](https://platzi.github.io/git-slides/#/) - Kompletny poradnik ze slajdami na temat Gita i Githuba po HiszpańskuUna guía completa de diapositivas sobre git y GitHub explicadas en Español.
- [Git Kraken](https://www.gitkraken.com/git-client) - Visual, cross-platform, and interactive `git` desktop application for version control. Program wizualizujący, przeznaczony na różne platformy i interaktywny do łatwiejszego używania kontroli wersji.
- [Git Tips](https://github.com/git-tips/tips) - Zbiór najpopularniejszych wskazówek i trików przy używaniu gita.
- [Git Best Practices](https://sethrobertson.github.io/GitBestPractices/) - Commituj często, udoskonalaj później, publikuj raz.
- [Git Interactive Tutorial](https://learngitbranching.js.org/) - Learn Git in the most visual and interactive way. Naucz się Gita w najbardziej wizualny i interaktywny sposób.
...
- [Producing Open Source Software](https://producingoss.com/) - jest to książka na temat ludzkiej strony tworzenia projektów Open Source. Opisuje jak odnoszące sukcesy projekty działają, oczekiwania użytkowników i programistów i kultury darmowego oprogramowania.
- [Open Source Book Series](https://opensource.com/resources/ebooks) - Naucz się więcej na temat Open Source i ciągle powiększającej się społeczności Open Source z wszechstronną listą darmowych eBooków z https://opensource.com
- [Software Release Practice HOWTO](https://en.tldp.org/HOWTO/Software-Release-Practice-HOWTO/) - opisuje dobre praktyki dla Linuxa i projektów Open Source. Poprzez wykorzystywanie tych praktyk. Skupisz się na zrobieniu tego co konieczne jak najprościej jak możliwe dla użytkownika, aby zbudować kod, który inni programiści będą rozumieć, aby mogli pomóc ci go udoskonalić.
- [Open Sources 2.0 : The Continuing Evolution](https://archive.org/details/opensources2.000diborich) (2005) - jest to kolekcja wnikliwych i dających do myślenia esejów od teraźniejszych liderów technologicznych którzy kontynuują rysowanie ciągle ewolującego obrazu, który został wytworzony w książce z 1999 roku [Open Sources: Voices from the Revolution.](https://www.amazon.com/Open-Sources-Voices-Source-Revolution/dp/1565925823)
- [The Architecture of Open Source Applications](http://www.aosabook.org/en/git.html) - Pokazuje jak różne nisko poziomowe aspekty Gita działają, aby pozwolić na rozproszony przepływ informacji i jak się to różni od innych systemów kontroli wersji (VCSs).
...
- [Up For Grabs](https://up-for-grabs.net/) - Zawiera projekty z kwestiami dla początkujących.
...
- [First Contributions](https://firstcontributions.github.io/) - Stwórz swoją pierwszą kontrybucje do projektu Open Source w 5 minut. Narzedzie i poradnik stworzony, aby pomóc początkującym zacząć z kontrybuowaniem. [Tutaj](https://github.com/firstcontributions/first-contributions) jest to kod źródłowy GitHuba dla strony i możliwości, aby wykonać kontrybucję do repozytorium samemu.
- [Hacktoberfest](https://hacktoberfest.digitalocean.com/) - Program zachęcający do kontrybuowania w projektach Open Source. Zarób prezęty takie jak koszulki czy naklejki za co najmniej 4 Pull Request-y w Październiku.
