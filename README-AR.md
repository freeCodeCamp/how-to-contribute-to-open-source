...
- [دليل خطوة بخطوة للمطور المبتدئ للمساهمة في المصدر المفتوح لأول مرة](https://hackernoon.com/contributing-to-open-source-the-sharks-are-photoshopped-47e22db1ab86) by [@LetaKeane](https://hackernoon.com/u/letakeane)
...
- [دليل تمهيدي للمصدر المفتوح](https://developeraspire.hashnode.dev/an-immersive-introductory-guide-to-open-source) by [Franklin Okolie](https://twitter.com/DeveloperAspire)
- [البدء في المساهمة في المصدر المفتوح](https://stackoverflow.blog/2020/08/03/getting-started-with-contributing-to-open-source/) by [Zara Cooper](https://stackoverflow.blog/author/zara-cooper/)
...
- [ ثمانية طرق للمساهمة في المصدر المفتوح من غير كتابة نص برمجي](https://opensource.com/life/16/1/8-ways-contribute-open-source-without-writing-code) by [OpenSource](https://twitter.com/OpenSourceWay)

## باستخدام التحكم في الإصدار
- [فكر مثل  (a) Git](http://think-like-a-git.net/) -  Git لـ "المبتدئين المتقدمين" ، لكنهم ما زالوا يعانون ، من أجل إعطائك إستراتيجية بسيطة لتجربة git مقدمة.
- [جرب Git](https://try.github.io/) -   (Git) في 15 دقيقية مجانا من متصفحك تعلم.
- [كل يوم Git](https://git-scm.com/docs/giteveryday) -  الحد الأدنى من مجموعة الأوامر المفيدة لكل يوم.
- [Oh shit, git!](https://ohshitgit.com/) - كيفية الخروج من أخطاء "git" الشائعة الموضحة في اللغة الإنجليزية البسيطة ؛ راجع أيضًا [Dangit، git!] (https://dangitgit.com/) للصفحة بدون شتائم.
- [Atlassian Git دروس](https://www.atlassian.com/git/tutorials) - دروس متنوعة حول استخدام "git".
- [GitHub Git ورقة المساعدة](https://education.github.com/git-cheat-sheet-education.pdf) (PDF)
- [موقع Wiki الخاص بـ freeCodeCamp على موارد Git](https://forum.freecodecamp.org/t/wiki-git-resources/13136)
- [GitHub تدفق](https://www.youtube.com/watch?v=juLIxo42A_s) (42:06) - يتحدث GitHub عن كيفية تقديم طلب سحب.
- [GitHub مصادر التعلم](https://docs.github.com/en/github/getting-started-with-github/git-and-github-learning-resources) - موارد التعلم Git و GitHub.
...
- [Git Guide for Beginners in Spanish](https://platzi.github.io/git-slides/#/) - شرح دليل كامل للشرائح حول git و GitHub. دليل كامل للشرائح على git و GitHub موضح باللغة الإسبانية.
...
- [Git نصائح](https://github.com/git-tips/tips) - مجموعة من النصائح والحيل الأكثر شيوعًا حول git.
- [Git أفضل الممارسات](https://sethrobertson.github.io/GitBestPractices/) - Commit Often, Perfect Later, Publish Once: Git Best Practices.
- [Git برنامج تعليمي تفاعلي](https://learngitbranching.js.org/) - git تعلم بالطريقة الأكثر بصرية وتفاعلية.

## كتب عن المصادر المفتوحة
...
- [سلسلة كتب عن المصادر المفتوحة](https://opensource.com/resources/ebooks) - تعرف على المزيد حول Open Source وحركة Open Source المتنامية مع قائمة شاملة من الكتب الإلكترونية المجانية من https://opensource.com.
- [كيفية إصدار البرنامج التدريبي](https://tldp.org/HOWTO/Software-Release-Practice-HOWTO/) - يصف هذا HOWTO ممارسات الإصدار الجيدة لنظام Linux ومشاريع أخرى مفتوحة المصدر. باتباع هذه الممارسات ، ستجعل من السهل على المستخدمين إنشاء التعليمات البرمجية الخاصة بك واستخدامها قدر الإمكان, ولكي يفهم المطورون الآخرون التعليمات البرمجية الخاصة بك ويتعاونون معك لتحسينها.
- [المصادر المفتوحة 2.0: التطور المستمر](https://archive.org/details/opensources2.000diborich) (2005) - Open Sources 2.0 هي مجموعة من المقالات الثاقبة والمثيرة للتفكير من قادة التكنولوجيا اليوم والتي تستمر في رسم الصورة التطورية التي تطورت في كتاب 1999 Open Sources: Voices from the Revolution.
- [هندسة التطبيقات مفتوحة المصدر](http://www.aosabook.org/en/git.html) - أظهر كيف تعمل الجوانب المختلفة لـ Git تحت الأغطية لتمكين مهام سير العمل الموزعة ، وكيف تختلف عن أنظمة التحكم في الإصدارات الأخرى (VCS).
- [مصادر مفتوحة: أصوات من ثورة المصادر المفتوحة](https://www.oreilly.com/openbook/opensources/book/) - مقالات من رواد المصادر المفتوحة مثل 
Linus Torvalds (Linux) و Larry Wall (Perl) و Richard Stallman (GNU). 

## مبادرات مساهمة المصادر المفتوحة
- [Up For Grabs](https://up-for-grabs.net/) - يحتوي على مشاريع ذات مواضيع صديقة للمبتدئين

- [الموقتات الأولى فقط](https://www.firsttimersonly.com/) - قائمة بالأخطاء التي تم تصنيفها "لأول مرة فقط".

- [المساهمات الأولى](https://firstcontributions.github.io/) - قدم أول مساهمة مفتوحة المصدر لك في 5 دقائق. أداة وبرنامج تعليمي لمساعدة المبتدئين على بدء المساهمات.
 [هنا](https://github.com/firstcontributions/first-contributions) هو مصدر GitHub للموقع والفرصة لتقديم مساهمة في المستودع نفسه.
...
- [24 Pull Requests](https://24pullrequests.com) - طلبات السحب هو مشروع لتعزيز التعاون مفتوح المصدر خلال شهر ديسمبر.
- 
- [Ovio](https://ovio.org) - منصة مع مجموعة منتقاة من المشاريع الصديقة للمساهمين. انها [أداة قوية للبحث عن القضايا](https://ovio.org/issues) ودعنا نحفظ المشاريع والمشكلات لوقت لاحق.
