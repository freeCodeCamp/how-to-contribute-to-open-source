...
#مرحبا بكم في المجتمع التعاوني لبناء وتطوير البرمجيات المفتوحة المصدر للمبتدئين.
...
[![Build Status](https://api.travis-ci.org/freeCodeCamp/how-to-contribute-to-open-source.svg?branch=master)](https://travis-ci.org/freeCodeCamp/how-to-contribute-to-open-source)
 ...
 هنا قائمة بمصادر للمبتدئين في مجال التعاون لبناء البرمجيات المفتوحة المصدر.

 إذا كان لديك أي مصادر أخرى ، رجاء قم بمشاركتها عن طريق "pull request"

إذا كان لديك أي أسئلة أو تعليقات ،رجاء قم بإنشاء مشكلة جديدة "issue"  

**المحتوى**

- [تطوير وبناء البرمجيات المفتوحة المصدر بشكل عام ](#تطوير_وبناء_البرمجيات_المفتوحة_المصدر)
- [البحث المباشر على GitHub](#البحث_المباشر_على_Gitub)
- [النظام التعاوني الخاص بـموزريلا](#لنظام_التعاوني_الخاص_بموزريلا)
- [بعض المقالات المفيدة للمبتدئين في بناء وتطوير البرمجيات المفتوحة المصدر ](#بعض_المقالات_المفيدة_للمبتدئين_في_بناء_وتطوير_البرمجيات_المفتوحة_المصدر)
- [التحكم بالنسخ للبرمجيات ](#التحكم_بالنسخ_للبرمجيات)
- [كتب مفتوحة المصدر](#كتب_مفتوحة_المصدر)
- [مبادرات في البرمجيات المفتوحة المصدر](#مبادرات_في_البرمجيات_المفتوحة_المصدر)
- [الرخصة](#الرخصة)
...
## تطوير وبناء البرمجيات المفتوحة المصدر بشكل عام 
...
## النظام التعاوني الخاص بـموزريلا
...
## بعض المقالات المفيدة للمبتدئين في بناء وتطوير البرمجيات المفتوحة المصدر
...
## مبادرات في البرمجيات المفتوحة المصدر
